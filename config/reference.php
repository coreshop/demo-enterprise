 ...
 *     },
 *     fake_ip?: Param|bool|string|array{
 *         enabled?: bool|Param, // Default: false
 ...
 *     },
 * }
 * @psalm-type CoreShopLoyaltyConfig = array{
 *     driver?: scalar|Param|null, // Default: "doctrine/orm"
 *     pimcore?: array{
 *         loyalty_voucher?: array{
 *             options?: mixed,
 *             path?: scalar|Param|null, // Default: "loyalty_vouchers"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "Pimcore\\Model\\DataObject\\CoreShopLoyaltyVoucher"
 *                 pimcore_class_name?: scalar|Param|null,
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Model\\LoyaltyVoucherInterface"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\PimcoreFactory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Pimcore\\Repository\\LoyaltyVoucherRepository"
 *                 install_file?: scalar|Param|null, // Default: "@CoreShopLoyaltyBundle/Resources/install/pimcore/classes/CoreShopLoyaltyVoucher.json"
 *                 type?: scalar|Param|null, // Default: "object"
 *             },
 *         },
 *     },
 *     resources?: array{
 *         loyalty_points_rule?: array{
 *             options?: mixed,
 *             permission?: scalar|Param|null, // Default: "loyalty_points_rule"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Model\\LoyaltyPointsRule"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Model\\LoyaltyPointsRuleInterface"
 *                 admin_controller?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Controller\\LoyaltyPointsRuleController"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\TranslatableFactory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Doctrine\\Repository\\LoyaltyPointsRuleRuleRepository"
 *                 form?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Form\\Type\\LoyaltyPointsRuleType"
 *             },
 *             translation?: array{
 *                 options?: mixed,
 *                 classes?: array{
 *                     model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Model\\LoyaltyPointsRuleTranslation"
 *                     interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Model\\LoyaltyPointsRuleTranslationInterface"
 *                     repository?: scalar|Param|null,
 *                     factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\Factory"
 *                     form?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Form\\Type\\LoyaltyPointsRuleTranslationType"
 *                 },
 *             },
 *         },
 *         loyalty_account?: array{
 *             options?: mixed,
 *             permission?: scalar|Param|null, // Default: "loyalty_account"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Model\\LoyaltyAccount"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Model\\LoyaltyAccountInterface"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Factory\\LoyaltyAccountFactory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Doctrine\\Repository\\LoyaltyAccountRepository"
 *             },
 *         },
 *         loyalty_points_transaction?: array{
 *             options?: mixed,
 *             permission?: scalar|Param|null, // Default: "loyalty_points_transaction"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Model\\LoyaltyPointsTransaction"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Model\\LoyaltyPointsTransactionInterface"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Bundle\\LoyaltyBundle\\Factory\\LoyaltyPointsTransactionFactory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\ResourceBundle\\Doctrine\\ORM\\EntityRepository"
 *             },
 *         },
 *     },
 * }
 * @psalm-type CoreShopVoucherCreditConfig = array{
 *     driver?: scalar|Param|null, // Default: "doctrine/orm"
 *     pimcore?: array{
 *         voucher_product?: array{
 *             options?: mixed,
 *             path?: scalar|Param|null, // Default: "supplier"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "Pimcore\\Model\\DataObject\\CoreShopVoucherProduct"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\VoucherCreditBundle\\Model\\VoucherProductInterface"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\PimcoreFactory"
 *                 repository?: scalar|Param|null,
 *                 install_file?: scalar|Param|null, // Default: "@CoreShopVoucherCreditBundle/Resources/install/pimcore/classes/CoreShopVoucherProduct.json"
 *                 type?: scalar|Param|null, // Default: "object"
 *             },
 *         },
 *         order_item_voucher?: array{
 *             options?: mixed,
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "Pimcore\\Model\\DataObject\\CoreShopOrderItemVoucher"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\VoucherCreditBundle\\Model\\OrderItemVoucherInterface"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\PimcoreFactory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\VoucherCreditBundle\\Repository\\OrderItemVoucherRepository"
 *                 install_file?: scalar|Param|null, // Default: "@CoreShopVoucherCreditBundle/Resources/install/pimcore/classes/CoreShopOrderItemVoucher.json"
 *                 type?: scalar|Param|null, // Default: "object"
 *             },
 *         },
 *     },
 ...
 * }
 * @psalm-type CoreShopEnterpriseSubscriptionConfig = array{
 *     token?: scalar|Param|null, // Default: "%env(default::CORESHOP_ENTERPRISE_TOKEN)%"
 *     production_system?: scalar|Param|null, // Default: "%env(bool:default:coreshop_enterprise_subscription_production_default:CORESHOP_ENTERPRISE_IS_PROD)%"
 * }
 * @psalm-type CoreShopDocumentRouteConfig = array{
 *     driver?: scalar|Param|null, // Default: "doctrine/orm"
 *     resources?: array{
 *         document_route?: array{
 *             options?: mixed,
 *             permission?: scalar|Param|null, // Default: "document_route"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\DocumentRouteBundle\\Model\\DocumentRoute"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\DocumentRouteBundle\\Model\\DocumentRouteInterface"
 *                 admin_controller?: scalar|Param|null, // Default: "CoreShop\\Bundle\\ResourceBundle\\Controller\\ResourceController"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\Factory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\DocumentRouteBundle\\Repository\\DocumentRouteRepository"
 *                 form?: scalar|Param|null, // Default: "CoreShop\\Bundle\\DocumentRouteBundle\\Form\\Type\\DocumentRouteType"
 *             },
 *         },
 *         document_site_route?: array{
 *             options?: mixed,
 *             permission?: scalar|Param|null, // Default: "document_route"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\DocumentRouteBundle\\Model\\DocumentSiteRoute"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\DocumentRouteBundle\\Model\\DocumentSiteRouteInterface"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\Factory"
 *                 repository?: scalar|Param|null,
 *                 form?: scalar|Param|null, // Default: "CoreShop\\Bundle\\DocumentRouteBundle\\Form\\Type\\DocumentSiteRouteType"
 *             },
 *             translation?: array{
 *                 options?: mixed,
 *                 classes?: array{
 *                     model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\DocumentRouteBundle\\Model\\DocumentSiteRouteTranslation"
 *                     interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\DocumentRouteBundle\\Model\\DocumentSiteRouteTranslationInterface"
 *                     repository?: scalar|Param|null,
 *                     factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\Factory"
 *                     form?: scalar|Param|null, // Default: "CoreShop\\Bundle\\DocumentRouteBundle\\Form\\Type\\DocumentSiteRouteTranslationType"
 *                 },
 *             },
 *         },
 *     },
 * }
 * @psalm-type CoreShopWarehouseConfig = array{
 *     driver?: scalar|Param|null, // Default: "doctrine/orm"
 *     resources?: array{
 *         warehouse?: array{
 *             options?: mixed,
 *             permission?: scalar|Param|null, // Default: "warehouse"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\WarehouseBundle\\Model\\Warehouse"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\WarehouseBundle\\Model\\WarehouseInterface"
 *                 admin_controller?: scalar|Param|null, // Default: "CoreShop\\Bundle\\ResourceBundle\\Controller\\ResourceController"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\Factory"
 *                 repository?: scalar|Param|null,
 *                 form?: scalar|Param|null, // Default: "CoreShop\\Bundle\\WarehouseBundle\\Form\\Type\\WarehouseType"
 *             },
 *         },
 *         warehouse_location?: array{
 *             options?: mixed,
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\WarehouseBundle\\Model\\WarehouseLocation"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\WarehouseBundle\\Model\\WarehouseLocationInterface"
 *                 admin_controller?: scalar|Param|null, // Default: "CoreShop\\Bundle\\WarehouseBundle\\Controller\\WarehouseLocationController"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\Factory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\WarehouseBundle\\Doctrine\\Repository\\WarehouseLocationRepository"
 *                 form?: scalar|Param|null, // Default: "CoreShop\\Bundle\\WarehouseBundle\\Form\\Type\\WarehouseLocationType"
 *             },
 *         },
 *         stock_item?: array{
 *             options?: mixed,
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\WarehouseBundle\\Model\\StockItem"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\WarehouseBundle\\Model\\StockItemInterface"
 *                 admin_controller?: scalar|Param|null, // Default: "CoreShop\\Bundle\\WarehouseBundle\\Controller\\StockItemController"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\Factory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\WarehouseBundle\\Doctrine\\Repository\\StockItemRepository"
 *             },
 *         },
 *         stock_movement?: array{
 *             options?: mixed,
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\WarehouseBundle\\Model\\StockMovement"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\WarehouseBundle\\Model\\StockMovementInterface"
 *                 admin_controller?: scalar|Param|null, // Default: "CoreShop\\Bundle\\WarehouseBundle\\Controller\\StockMovementController"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\Factory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\WarehouseBundle\\Doctrine\\Repository\\StockMovementRepository"
 *             },
 *         },
 *     },
 *     stack?: array{
 *         stockable?: scalar|Param|null, // Default: "CoreShop\\Component\\Inventory\\Model\\StockableInterface"
 *     },
 * }
 * @psalm-type CoreShopDepositConfig = array{
 *     resources?: array{
 *         deposit_store_values?: array{
 *             options?: mixed,
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\DepositBundle\\Model\\DepositStoreValues"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\DepositBundle\\Model\\DepositStoreValuesInterface"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\Factory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\DepositBundle\\Doctrine\\ORM\\DepositStoreValuesRepository"
 *             },
 *         },
 *     },
 * }
 * @psalm-type CoreShopInboundEmailRulesConfig = array{
 *     driver?: scalar|Param|null, // Default: "doctrine/orm"
 *     resources?: array{
 *         inbound_email?: array{
 *             options?: mixed,
 *             permission?: scalar|Param|null, // Default: "inbound_email"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\InboundEmailRulesBundle\\Model\\InboundEmail"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\InboundEmailRulesBundle\\Model\\InboundEmailInterface"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\Factory"
 *                 repository?: scalar|Param|null,
 *                 admin_controller?: scalar|Param|null, // Default: "CoreShop\\Bundle\\ResourceBundle\\Controller\\ResourceController"
 *                 form?: scalar|Param|null, // Default: "CoreShop\\Bundle\\InboundEmailRulesBundle\\Form\\Type\\InboundEmailType"
 *             },
 *         },
 *         inbound_email_rule?: array{
 *             options?: mixed,
 *             permission?: scalar|Param|null, // Default: "inbound_email_rule"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\InboundEmailRulesBundle\\Model\\InboundEmailRule"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\InboundEmailRulesBundle\\Model\\InboundEmailRuleInterface"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\Factory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\InboundEmailRulesBundle\\Doctrine\\ORM\\InboundEmailRuleRepository"
 *                 admin_controller?: scalar|Param|null, // Default: "CoreShop\\Bundle\\InboundEmailRulesBundle\\Controller\\InboundEmailRuleController"
 *                 form?: scalar|Param|null, // Default: "CoreShop\\Bundle\\InboundEmailRulesBundle\\Form\\Type\\InboundEmailRuleType"
 *             },
 *         },
 *     },
 * }
 * @psalm-type CoreShopBatchMessengerConfig = array{
 *     driver?: scalar|Param|null, // Default: "doctrine/orm"
 *     resources?: array{
 *         task?: array{
 *             options?: mixed,
 *             permission?: scalar|Param|null, // Default: "batch_messenger_task"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\BatchMessengerBundle\\Model\\Task"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\BatchMessengerBundle\\Model\\TaskInterface"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Bundle\\BatchMessengerBundle\\Factory\\TaskFactory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\BatchMessengerBundle\\Repository\\TaskRepository"
 *                 admin_controller?: scalar|Param|null, // Default: "CoreShop\\Bundle\\BatchMessengerBundle\\Controller\\TaskController"
 *             },
 *         },
 *         task_item?: array{
 *             options?: mixed,
 *             permission?: scalar|Param|null, // Default: "batch_messenger_task_item"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\BatchMessengerBundle\\Model\\TaskItem"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\BatchMessengerBundle\\Model\\TaskItemInterface"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Bundle\\BatchMessengerBundle\\Factory\\TaskItemFactory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\ResourceBundle\\Doctrine\\ORM\\EntityRepository"
 *             },
 *         },
 *     },
 * }
 * @psalm-type CoreShopCustomerClusterConfig = array{
 *     driver?: scalar|Param|null, // Default: "doctrine/orm"
 *     resources?: array{
 *         customer_cluster?: array{
 *             options?: mixed,
 *             permission?: scalar|Param|null, // Default: "customer_cluster"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "CoreShop\\Bundle\\CustomerClusterBundle\\Model\\CustomerCluster"
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\CustomerClusterBundle\\Model\\CustomerClusterInterface"
 *                 admin_controller?: scalar|Param|null, // Default: "CoreShop\\Bundle\\ResourceBundle\\Controller\\ResourceController"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\Factory"
 *                 form?: scalar|Param|null, // Default: "CoreShop\\Bundle\\CustomerClusterBundle\\Form\\Type\\CustomerClusterType"
 *             },
 *         },
 *     },
 * }
 ...
 *     },
 * }
 * @psalm-type CoreShopTicketingConfig = array{
 *     driver?: scalar|Param|null, // Default: "doctrine/orm"
 *     pimcore?: array{
 *         event?: array{
 *             options?: mixed,
 *             path?: scalar|Param|null, // Default: "events"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "Pimcore\\Model\\DataObject\\CoreShopEvent"
 *                 pimcore_class_name?: scalar|Param|null,
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\TicketingBundle\\Model\\EventInterface"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\PimcoreFactory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\CoreBundle\\Pimcore\\Repository\\ProductRepository"
 *                 install_file?: scalar|Param|null, // Default: "@CoreShopTicketingBundle/Resources/install/pimcore/classes/CoreShopEvent.json"
 *                 type?: scalar|Param|null, // Default: "object"
 *             },
 *         },
 *         event_pass?: array{
 *             options?: mixed,
 *             path?: scalar|Param|null, // Default: "event_passes"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "Pimcore\\Model\\DataObject\\CoreShopEventPass"
 *                 pimcore_class_name?: scalar|Param|null,
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\TicketingBundle\\Model\\EventPassInterface"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Component\\Resource\\Factory\\PimcoreFactory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\CoreBundle\\Pimcore\\Repository\\ProductRepository"
 *                 install_file?: scalar|Param|null, // Default: "@CoreShopTicketingBundle/Resources/install/pimcore/classes/CoreShopEventPass.json"
 *                 type?: scalar|Param|null, // Default: "object"
 *             },
 *         },
 *         event_ticket?: array{
 *             options?: mixed,
 *             path?: scalar|Param|null, // Default: "tickets"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "Pimcore\\Model\\DataObject\\CoreShopEventTicket"
 *                 pimcore_class_name?: scalar|Param|null,
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\TicketingBundle\\Model\\EventTicketInterface"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Bundle\\TicketingBundle\\Factory\\EventTicketFactory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\TicketingBundle\\Repository\\EventTicketRepository"
 *                 install_file?: scalar|Param|null, // Default: "@CoreShopTicketingBundle/Resources/install/pimcore/classes/CoreShopEventTicket.json"
 *                 type?: scalar|Param|null, // Default: "object"
 *             },
 *         },
 *         event_ticket_scan?: array{
 *             options?: mixed,
 *             path?: scalar|Param|null, // Default: "tickets"
 *             classes?: array{
 *                 model?: scalar|Param|null, // Default: "Pimcore\\Model\\DataObject\\CoreShopEventTicketScan"
 *                 pimcore_class_name?: scalar|Param|null,
 *                 interface?: scalar|Param|null, // Default: "CoreShop\\Bundle\\TicketingBundle\\Model\\EventTicketScanInterface"
 *                 factory?: scalar|Param|null, // Default: "CoreShop\\Bundle\\TicketingBundle\\Factory\\EventTicketScanFactory"
 *                 repository?: scalar|Param|null, // Default: "CoreShop\\Bundle\\TicketingBundle\\Repository\\EventTicketScanRepository"
 *                 install_file?: scalar|Param|null, // Default: "@CoreShopTicketingBundle/Resources/install/pimcore/classes/CoreShopEventTicketScan.json"
 *                 type?: scalar|Param|null, // Default: "object"
 *             },
 *         },
 *     },
 *     stack?: array{
 *         event?: scalar|Param|null, // Default: "CoreShop\\Bundle\\TicketingBundle\\Model\\EventInterface"
 *         event_ticket?: scalar|Param|null, // Default: "CoreShop\\Bundle\\TicketingBundle\\Model\\EventTicketInterface"
 *         event_ticket_scan?: scalar|Param|null, // Default: "CoreShop\\Bundle\\TicketingBundle\\Model\\EventTicketScanInterface"
 *         event_pass?: scalar|Param|null, // Default: "CoreShop\\Bundle\\TicketingBundle\\Model\\EventPassInterface"
 *         ticketable?: scalar|Param|null, // Default: "CoreShop\\Bundle\\TicketingBundle\\Model\\TicketableInterface"
 *     },
 *     pk_pass?: array{
 *         enabled?: bool|Param, // Default: false
 *         certificate?: scalar|Param|null,
 *         certificate_password?: scalar|Param|null,
 *         team_identifier?: scalar|Param|null,
 *         pass_type_identifier?: scalar|Param|null,
 *     },
 * }
 ...
 *     core_shop_loyalty?: CoreShopLoyaltyConfig,
 *     core_shop_voucher_credit?: CoreShopVoucherCreditConfig,
 ...
 *     core_shop_enterprise_subscription?: CoreShopEnterpriseSubscriptionConfig,
 *     core_shop_document_route?: CoreShopDocumentRouteConfig,
 *     core_shop_warehouse?: CoreShopWarehouseConfig,
 *     core_shop_deposit?: CoreShopDepositConfig,
 *     core_shop_inbound_email_rules?: CoreShopInboundEmailRulesConfig,
 *     core_shop_batch_messenger?: CoreShopBatchMessengerConfig,
 *     core_shop_customer_cluster?: CoreShopCustomerClusterConfig,
 *     pimcore_data_hub?: PimcoreDataHubConfig,
 *     core_shop_ticketing?: CoreShopTicketingConfig,
